...
LRESULT CALLBACK Cone(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
	TCHAR vIDC_Dx[10]=TEXT("0"),vIDC_Dy[10]=TEXT("0"),vIDC_Dz[10]=TEXT("0"),vIDC_AxeX[10]=TEXT("1"),vIDC_AxeY[10]=TEXT("0"),vIDC_AxeZ[10]=TEXT("0"),
		  vIDC_Angle[10]=TEXT("0"),vIDC_R[10]=TEXT("1.0"),vIDC_H[10]=TEXT("2.0");
	char nom[10]="objet";
	...
	switch (msg) {
		case WM_INITDIALOG :
			...
			SetDlgItemText( hwnd, IDC_AxeZ,vIDC_AxeZ);
			SetDlgItemText( hwnd, IDC_Angle,vIDC_Angle);
			SetDlgItemText( hwnd, IDC_R,vIDC_R);
		...
		case WM_COMMAND :
			switch LOWORD(wParam)  {
				...
				case IDOK :
					...
					GetDlgItemText(hwnd,IDC_AxeZ,vIDC_AxeZ,10);
					GetDlgItemText(hwnd,IDC_Angle,vIDC_Angle,10);
					GetDlgItemText(hwnd,IDC_R,vIDC_R,10);
...
LRESULT CALLBACK Texte(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
	TCHAR vIDC_Dx[10]=TEXT("0"),vIDC_Dy[10]=TEXT("0"),vIDC_Dz[10]=TEXT("0"),vIDC_AxeX[10]=TEXT("1"),vIDC_AxeY[10]=TEXT("0"),vIDC_AxeZ[10]=TEXT("0"),
		  vIDC_Angle[10]=TEXT("0"),vIDC_TEXTE[10]=TEXT("Zouhir");
	char nom[10]="objet";
	...
	switch (msg) {
		case WM_INITDIALOG :
			...
			SetDlgItemText( hwnd, IDC_AxeZ,vIDC_AxeZ);
			SetDlgItemText( hwnd, IDC_Angle,vIDC_Angle);
			SetDlgItemText( hwnd, IDC_TEXTE,vIDC_TEXTE);
			hwndcombo = GetDlgItem (hwnd, IDC_COMBO_FIXE);
			hwndcombo2 = GetDlgItem (hwnd, IDC_COMBO_ANIME);
		...
		case WM_COMMAND :
			switch LOWORD(wParam)  {
				...
				case IDOK :
					...
					GetDlgItemText(hwnd,IDC_AxeZ,vIDC_AxeZ,10);
					GetDlgItemText(hwnd,IDC_Angle,vIDC_Angle,10);
					GetDlgItemText(hwnd,IDC_TEXTE,vIDC_TEXTE,10);
					SendDlgItemMessage(hwnd, IDC_COMBO_FIXE,WM_GETTEXT, sizeof(urll),(LPARAM) urll);
					SendDlgItemMessage(hwnd, IDC_COMBO_ANIME,WM_GETTEXT, sizeof(url2),(LPARAM) url2);
...
LRESULT CALLBACK Lumiere_Directionnelle(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
	TCHAR vIDC_IA1[10]=TEXT("0"),vIDC_I1[10]=TEXT("1"),vIDC_C1[10]=TEXT("1"),vIDC_C2[10]=TEXT("1"),vIDC_C3[10]=TEXT("1"),
		  vIDC_D1[10]=TEXT("0"),vIDC_D2[10]=TEXT("0"),vIDC_D3[10]=TEXT("-1");
	char nom[10]="objet";
	...
	switch (msg) {
		case WM_INITDIALOG :
			...
			CheckDlgButton(hwnd, IDC_Activer, BST_CHECKED);
		return 0;
...
LRESULT CALLBACK Lumiere_Ponctuelle(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
	TCHAR vIDC_IA1[10]=TEXT("0"), vIDC_A1[10]=TEXT("1.0"),vIDC_A2[10]=TEXT("0.0"),vIDC_A3[10]=TEXT("0.0"), 
		vIDC_C1[10]=TEXT("1"),vIDC_C2[10]=TEXT("1"),vIDC_C3[10]=TEXT("1"),
		vIDC_I1[10]=TEXT("1"),vIDC_L1[10]=TEXT("0"),vIDC_L2[10]=TEXT("0"),vIDC_L3[10]=TEXT("0"),vIDC_R1[10]=TEXT("100") ;
	char nom[10]="objet";
...
LRESULT CALLBACK cylindreSensor(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
TCHAR vIDC_MinA[10]=TEXT("0"), vIDC_MaxA[10]=TEXT("-1"),vIDC_DiskA[10]=TEXT("0.262"),vIDC_OffSet1[10]=TEXT("0");
		
	   
    
	switch (msg) {
		case WM_INITDIALOG :
			SetDlgItemText(hwnd, IDC_MinA,vIDC_MinA);
			SetDlgItemText(hwnd, IDC_MaxA,vIDC_MaxA);
			SetDlgItemText(hwnd, IDC_DiskA,vIDC_DiskA);
		...
		case WM_COMMAND :
			switch LOWORD(wParam)  {
				...
				case IDOK :
					GetDlgItemText(hwnd, IDC_MinA,vIDC_MinA,10);
					GetDlgItemText(hwnd, IDC_MaxA,vIDC_MaxA,10);
					GetDlgItemText(hwnd, IDC_DiskA,vIDC_DiskA,10);
...
TCHAR vIDC_MinPosition1[10]=TEXT("0"),vIDC_MinPosition2[10]=TEXT("0"),
		...
		case WM_COMMAND :
			switch LOWORD(wParam)  {
				...
				case IDOK :
					...
					GetDlgItemText(hwnd, IDC_MinPosition2,vIDC_MinPosition2,10);
				...
				if(IsDlgButtonChecked(hwnd, IDC_enabled) == BST_CHECKED) fprintf(fich,"enabled TRUE\n");
					...
					fprintf(fich,"maxPosition %g %g \n",_wtof(vIDC_MaxPosition1),_wtof(vIDC_MaxPosition2));
					fprintf(fich,"minPosition %g %g \n",_wtof(vIDC_MinPosition1),_wtof(vIDC_MinPosition2));
		...
		case WM_COMMAND :
			switch LOWORD(wParam)  {
				...
				if(IsDlgButtonChecked(hwnd, IDC_enabled) == BST_CHECKED) fprintf(fich,"enabled TRUE\n");
					...
					fprintf(fich,"offset %g %g %g %g \n",_wtof(vIDC_OFFSET1),_wtof(vIDC_OFFSET2),_wtof(vIDC_OFFSET3),_wtof(vIDC_OFFSET4));
...
LRESULT CALLBACK Fond(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
	TCHAR vIDC_Angle1[10]=TEXT("0"),vIDC_Angle2[10]=TEXT("0"),vIDC_Angle3[10]=TEXT("0"),vIDC_C1[10]=TEXT("1"),vIDC_C2[10]=TEXT("0"),vIDC_C3[10]=TEXT("0"),
		  ...
		  vIDC_Angle4[10]=TEXT("0"),vIDC_Angle5[10]=TEXT("1.0"),vIDC_Angle6[10]=TEXT("2.0"),vIDC_G1[10]=TEXT("1"),vIDC_G2[10]=TEXT("0"),vIDC_G3[10]=TEXT("0"),
	...
	switch (msg) {
		case WM_INITDIALOG :
			SetDlgItemText( hwnd, IDC_Angle1,vIDC_Angle1 );
			SetDlgItemText( hwnd, IDC_Angle2,vIDC_Angle2 );
			SetDlgItemText( hwnd, IDC_Angle3,vIDC_Angle3 );
			SetDlgItemText( hwnd, IDC_C1,vIDC_C1);
			SetDlgItemText( hwnd, IDC_C2,vIDC_C2);
			SetDlgItemText( hwnd, IDC_C3,vIDC_C3);
			...
			SetDlgItemText( hwnd, IDC_Angle4,vIDC_Angle4);
			SetDlgItemText( hwnd, IDC_Angle5,vIDC_Angle5);
			SetDlgItemText( hwnd, IDC_Angle6,vIDC_Angle6);
		...
		case WM_COMMAND :
			switch LOWORD(wParam)  {
				...
				case IDOK :
					GetDlgItemText(hwnd,IDC_Angle1,vIDC_Angle1,10);
					GetDlgItemText(hwnd,IDC_Angle2,vIDC_Angle2,10);
					GetDlgItemText(hwnd,IDC_Angle3,vIDC_Angle3,10);
					GetDlgItemText(hwnd,IDC_C1,vIDC_C1,10);
					GetDlgItemText(hwnd,IDC_C2,vIDC_C2,10);
					GetDlgItemText(hwnd,IDC_C3,vIDC_C3,10);
					...
					GetDlgItemText(hwnd,IDC_Angle4,vIDC_Angle4,10);
					GetDlgItemText(hwnd,IDC_Angle5,vIDC_Angle5,10);
					GetDlgItemText(hwnd,IDC_Angle6,vIDC_Angle6,10);
					...
					fwprintf(fich,L"skyAngle [%s %s %s]\n",vIDC_Angle1, vIDC_Angle2, vIDC_Angle3);
					...
					fwprintf(fich,L"groundAngle [%s %s %s]\n",vIDC_Angle4, vIDC_Angle5, vIDC_Angle6);
...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_COMMAND:
		  ...
		  case ID_SENSOR_CY: 
			   ...
			   DialogBox(NULL,MAKEINTRESOURCE(IDD_cylindreSensor), hwnd, (DLGPROC)cylindreSensor);
			   InvalidateRect (hwnd, NULL, TRUE) ;
			   return 0;
